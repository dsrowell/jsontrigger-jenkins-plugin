...
public class WebhookTriggerBuildAction implements EnvironmentContributingAction {
    ...
    public WebhookTriggerBuildAction(final TriggerWebhook hook) {
        this.hook = hook;
    }
     ...
     *         {@code nestingPrefix=artifact}, {@code HOOK_ARTIFACT_BUILD_ID} would be returned.
     */
